    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          <section>
            <p>
              株価分析AIカルテ（以下「当社」）は、本サービスにおける、
              ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」）を定めます。
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3 text-gray-900">第1条（個人情報）</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-gray-900">第2条（個人情報の収集方法）</h2>
            <p>当社は、ユーザーが利用登録をする際に以下の情報を取得します：</p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
              <li>メールアドレス</li>
              <li>氏名またはニックネーム</li>
              <li>Googleアカウント情報（Googleログインを利用した場合）</li>
              <li>プロフィール画像（設定した場合）</li>
            </ul>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-gray-900">第3条（個人情報を収集・利用する目的）</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-gray-900">第4条（利用目的の変更）</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-gray-900">第5条（個人情報の第三者提供）</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-gray-900">第6条（個人情報の開示）</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-gray-900">第7条（個人情報の訂正および削除）</h2>
            <ol className="list-decimal pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-gray-900">第8条（個人情報の利用停止等）</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-gray-900">第9条（Cookie）</h2>
            <p>
              本サービスでは、ユーザー体験の向上のためにCookieを使用しています。
              Cookieは、ウェブサイトがお客様のコンピュータやモバイルデバイスに送信する小さなデータファイルで、
              サイトの機能向上やユーザー行動の分析に使用されます。
            </p>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-gray-900">第10条（プライバシーポリシーの変更）</h2>
            <ol className="list-decimal pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-gray-900">第11条（お問い合わせ窓口）</h2>
            <p>本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。</p>
            <div className="mt-3 p-4 bg-gray-100 rounded">
              <p>サービス名：株価分析AIカルテ</p>
              <p>Eメール：[お問い合わせメールアドレス]</p>
            </div>
          </section>
